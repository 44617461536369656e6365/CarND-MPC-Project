            ...
            if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
                ...
                if (s != "") {
                    ...
                    if (event == "telemetry") {
                        ...
                        *
                        */
                        auto vehicle_pts = transform_to_vehicle_coordinates(
                            ptsx, ptsy, psi, px, py);
                        ...
                        auto const vars = mpc.Solve(state, coeffs);
                        auto const steer_value = vars[0];
                        auto const throttle_value = vars[1];
